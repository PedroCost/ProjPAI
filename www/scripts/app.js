...
function setTextColor(picker) {
    document.getElementById('text-to-read').style.backgroundColor  = '#' + picker.toString()
}
...
$(document).ready(function() {
    ...
    $('#font-family').val(prefs.font);
    $('body').css("fontFamily", prefs.font);
    ...
    $('#start').on('click', function() {
        ...
        if(data.reading === false) {
            ...
            document.getElementById('text-progress').style.visibility = 'visible';
        } else {
            stop();
        }
    });
    ...
    $('#font-family').on('change', function() {
        ...
        savePrefs();
        $('body').css("fontFamily", this.value);
    });
    ...
    $('body').on('keyup', function(e) {
        ...
        if(e.keyCode == 80 || e.keyCode == 32) {
            ...
            // Right arrow
            // Increase WPM by 10
            $('#reading-speed').val(prefs.speed + 10).trigger('change');
